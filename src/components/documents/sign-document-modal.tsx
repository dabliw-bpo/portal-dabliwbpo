        ...
        <form action={formAction} className="mt-4 flex flex-col gap-4">
          ...
          <div className="flex justify-end gap-3">
            <button
              ...
              className="rounded-md px-4 py-2 text-sm font-medium text-slate-600 hover:bg-slate-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-slate-500"
            >
              Cancelar
            </button>
            <button
